...
Object.preventExtensions(Object.setPrototypeOf(Object.freeze(Object.setPrototypeOf(Tokenizer$1, null)).prototype, null));
...
class TokenMatcher extends Matcher {
  ...
  static createMode(matcher, options) {
    const tokenizer = (({constructor, ...tokenizerPropertyDescriptors}) =>
      ...
      Object.getOwnPropertyDescriptors(Tokenizer$1.prototype),
    );
