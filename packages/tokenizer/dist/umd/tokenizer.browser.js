(function (global, factory) {
  ...
  typeof process === 'object' && console.info('[ESM]: %o', (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.js', document.baseURI).href)));
  ...
  Object.freeze(Object.freeze(Tokenizer$1.prototype).constructor);

  new Parser({url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.js', document.baseURI).href))});
  ...
  const experimentalExtendedParser = (() => new Parser({url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.js', document.baseURI).href)), modes}))();
