(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.tokenizer = {}));
  ...
  new Parser({url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('tokenizer.experimental.js', document.baseURI).href))});
  ...
  const tokenizer_experimental_extended = (() => new Parser({url: (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('tokenizer.experimental.js', document.baseURI).href)), modes}))();
