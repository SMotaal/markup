const tokenizer = (function (exports) {
  ...
  new Parser({url: (document.currentScript && document.currentScript.src || new URL('tokenizer.experimental.js', document.baseURI).href)});
  ...
  const tokenizer_experimental_extended = (() => new Parser({url: (document.currentScript && document.currentScript.src || new URL('tokenizer.experimental.js', document.baseURI).href), modes}))();
