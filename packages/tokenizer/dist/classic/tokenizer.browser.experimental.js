const markup = (function (exports) {
  ...
  Object.assign(new Parser(), {MODULE_URL: (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.experimental.js', document.baseURI).href)});
  ...
  const experimentalExtendedParser = (() => {
    const experimentalExtendedParser = Object.assign(new Parser(), {MODULE_URL: (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.experimental.js', document.baseURI).href)});
