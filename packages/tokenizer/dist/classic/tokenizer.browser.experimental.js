const markup = (function (exports) {
  ...
  new Parser({url: (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.experimental.js', document.baseURI).href)});
  ...
  const experimentalExtendedParser = (() => new Parser({url: (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.experimental.js', document.baseURI).href), modes}))();
