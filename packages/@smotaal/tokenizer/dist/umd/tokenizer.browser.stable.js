(function (global, factory) {
  ...
  typeof process === 'object' && console.info('[ESM]: %o', (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.stable.js', document.baseURI).href)));
  ...
  parser.MODULE_URL = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('tokenizer.browser.stable.js', document.baseURI).href));
