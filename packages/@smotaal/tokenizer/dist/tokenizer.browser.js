(function (global, factory) {
  ...
  (global = global || self, factory((global.markup = global.markup || {}, global.markup.tokenizer = {})));
  ...
  const markdown = Object.defineProperties(
    ({syntax} = defaults, {html}) => {
      const matcher = ((...matchers$$1) => {
        let matcher = matchers$$1[matchers$$1.length - 1];
        try {
          matchers$$1.push(
          ...
          matchers$$1.push(exception.message.replace(/.*Invalid regular expression: /, ''));
          console.warn(exception);
        }
        matcher.matchers = matchers$$1;
        return matcher;
      })(
  ...
  const mjs = Object.defineProperties(
    ({syntax} = mjs.defaults, {javascript: {quotes, closures, spans, matchers: matchers$$1}}) => ({
      syntax,
      ...
      matchers: {quote: matchers$$1.quote, closure: javascript.CLOSURE},
    }),
    {
  ...
  const cjs = Object.defineProperties(
    ({syntax} = cjs.defaults, {javascript: {quotes, closures, spans, matchers: matchers$$1}}) => ({
      syntax,
  ...
  const esx = Object.defineProperties(
    ({syntax} = esx.defaults, {javascript: {quotes, closures, spans, matchers: matchers$$1}, mjs, cjs}) => ({
      syntax,
      ...
      matchers: {quote: matchers$$1.quote, closure: javascript.ESX},
    }),
    {
