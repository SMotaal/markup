...
export function* contextualizer($, defaults) {
  ...
  //   // matcher.matcher || (matcher.matcher = new RegExp(matcher.source, matcher.flags.replace('g', 'y')));
  ...
  // const { syntax: $syntax, matcher: $matcher, quotes: $quotes, punctuators: $punctuators, punctuators: {aggregators: $aggregators} } = $;
