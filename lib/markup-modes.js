import {defaults, syntaxes, modes, patterns} from './markup.js';
...
// syntaxes.es.closures['('].goal = 'parenthesis';
// syntaxes.es.closures['['].goal = 'array';
// syntaxes.es.closures['{'].goal = 'block';
// literals: {
//   '/': {'regexp': /\/[^\/].*?\//}
// },
// nonbreakers: symbols(`.`),
