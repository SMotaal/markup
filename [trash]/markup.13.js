...
export function* contextualize(state, defaults) {
  const mode = state.mode;

  while (true) {
    const {
      [(state.syntax = mode.syntax)]: $ = defaults.syntaxes[defaults.syntax],
    } = defaults.syntaxes;
    ...
    // {
    //   const {
    //     matcher = (syntax.matcher = defaults.matcher),
    //     punctuators = ($.punctuators = {aggregators: {}}),
    //     punctuators: {aggregators = (punctuators.aggregators = {})},
    //     // punctuators: {aggregators: punctuators.aggregators = {}} = ($.punctuators = {aggregators: {}}),
    ...
    while ($syntax === $.syntax) {
      ...
      const $$context = ($grouper && $grouper.context) || $.context;
