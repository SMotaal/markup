import {modes, syntaxes} from './modes.js';
import {patterns} from './patterns.js';

export const defaults = {
  matcher: syntaxes.default.matcher,
  syntax: 'default',
  sourceType: 'default',
...
export class Tokenizer {
  ...
  *tokenize(source, state = {}) {
    ...
    // Local context
    const contextualizer = this.contextualizer || (
      this.contextualizer = this.constructor.contextualizer(this)
    );
