    ...
    while (!done && $syntax === $.syntax) {
      ...
      while (!done && $grouper === state.grouper) {
        ...
        if (punctuator || closing) {
          ...
          if (closing) {
          ...
          } else if (!$grouping.terminator && $$punctuator !== 'comment') {
            ...
            const canOpen = $$punctuator !== 'quote';
            const canSpan = $$spans;

            if (canOpen && punctuator === 'quote') {
              opened =
                grouper ||
                createGrouper({
                  goal: 'quote',
            ...
            } else if (canOpen && punctuator === 'comment') {
              opened =
                grouper ||
                createGrouper({
                  goal: 'comment',
            ...
            } else if (canOpen && punctuator === 'closure') {
