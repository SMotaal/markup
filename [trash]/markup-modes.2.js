...
Object.assign(syntaxes, {
  md: {
    ...
    // matcher: /(^\s+|\n)|((?:```+|\~\~\~+|---+|(?:\#{1,5}|\-|\b\d+\.|\b[a-z]\.|[ivx]+\.)(?=\s+\S+))|\*\*?|\~\~?|__?|"|'|=|\/>|(?<![*~_\`])>|<%|%>|<!--|-->|<[\/\!]?(?=[a-z]+\:?[a-z\-]*[a-z]|[a-z]+))/gim,
    // matcher: /(^\s+|\n)|((?<=^\s*)(?:\`\`\`|\~\~\~|\-{3,}|(?:\#{1,5}|\-|\d+\.|[a-z]\.|[ivx]+\.)(?=\s+\S+))|\*\*?|\~\~?|__?|"|'|=|\/>|(?<![*~_\`])>|<%|%>|<!--|-->|<[\/\!]?(?=[a-z]+\:?[a-z\-]*[a-z]|[a-z]+))/gim,
    // matcher: /(^\s+|\n)|((?<=^\s*)(?:\`\`\`|\~\~\~|\-{3,}|(?:\#{1,5}|\-|\d+\.|[a-z]\.|[ivx]+\.)(?=\s+\S+))|\*\*?(?![\s\n])|(?<![\s\n])\*\*?|\~\~?\b|\b\~\~?|\`+\b|\b\`+|__?\b|\b__?|"|'|=|\/>|(?<![*~_\`])>|<%|%>|<!--|-->|<[\/\!]?(?=[a-z]+\:?[a-z\-]*[a-z]|[a-z]+))/gim,
    // matcher: /(?=(^\s+|\n)?)(?:^\s+|\n|((?:\`\`\`|\~\~\~|\-{3,}|(?:\#{1,5}|\-|\d+\.|[a-z]\.|[ivx]+\.)(?=\s+\S+))|\*\*?\b|\b\*\*?|\~\~?\b|\b\~\~?|\`+\b|\b\`+|__?\b|\b__?|"|'|=|\/>|(?<![*~_\`])>|<%|%>|<!--|-->|<[\/\!]?(?=[a-z]+\:?[a-z\-]*[a-z]|[a-z]+)))/gim,
    matchers: {
      // quote: /(\n)|(\\(?:(?:\\\\)*\\|[^\\\s])|"|')/g,
      comment: /(\n)|(-->)/g,
    },
...
// syntaxes.html.patterns = {...syntaxes.html.patterns, closeTag: /<\/\w[^<>{}]*?>/g};
